...
public class LazyImageLoader {
	...
	/**
	 * 使用方法示例:profile_image.setImageBitmap(TwitterApplication.mImageLoader.get(tweet.profileImageUrl, callback));
		...
		public void run() {
			try {
				while (!mTaskTerminated) {
					...
					{
						Log.v(TAG, "mImageManager.safeGet(url);");
					}
