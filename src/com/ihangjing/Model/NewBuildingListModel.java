 ...
 *
 */
public class NewBuildingListModel {
	private String cacheKey = "";
	public ArrayList<NewBuildingInfo> list;
	private int page;
	private int total;

	public NewBuildingListModel() {
		this.list = new ArrayList<NewBuildingInfo>();
	}
	...
	public String beanToString() {
		...
		try {
			...
			Iterator<NewBuildingInfo> localIterator = this.list.iterator();
	...
	public NewBuildingListModel stringToBean(String paramString) {
		if ((paramString == null)
		...
		try {
			...
			while (true) {
				...
				NewBuildingInfo localShopBean1 = new NewBuildingInfo();
