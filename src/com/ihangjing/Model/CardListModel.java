...
public class CardListModel {
	...
	public CardListModel() {
		this.list = new ArrayList<CardInfo>();
	}
	...
	public String beanToString() {
		...
		try {
			...
			Iterator<CardInfo> localIterator = this.list.iterator();
	...
	public CardListModel stringToBean(String paramString) {
		if ((paramString == null)
		...
		try {
			...
			while (true) {
				...
				CardInfo localShopBean1 = new CardInfo();
