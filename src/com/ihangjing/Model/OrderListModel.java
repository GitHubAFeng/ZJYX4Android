...
public class OrderListModel {
	...
	public ArrayList<SimpleOrderModel> list;
	private int page;
	private int total;

	public OrderListModel() {
		this.list = new ArrayList<SimpleOrderModel>();
	}
	...
	public String beanToString() {
		...
		try {
			...
			Iterator<SimpleOrderModel> localIterator = this.list.iterator();

			while (true) {
				if (!localIterator.hasNext()) {
					localJSONObject1.put("orderlist", localJSONArray1);
	...
	public OrderListModel stringToBean(String paramString) {
		if ((paramString == null)
		...
		try {
			...
			while (true) {
				...
				SimpleOrderModel localShopBean1 = new SimpleOrderModel();
