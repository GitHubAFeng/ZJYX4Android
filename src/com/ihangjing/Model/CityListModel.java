...
public class CityListModel {
	...
	public CityListModel() {
		this.list = new ArrayList<CityInfo>();
	}
	...
	public String beanToString() {
		...
		try {
			...
			Iterator<CityInfo> localIterator = this.list.iterator();
	...
	public CityListModel stringToBean(String paramString) {
		if ((paramString == null)
		...
		try {
			...
			while (true) {
				...
				CityInfo localShopBean1 = new CityInfo();
