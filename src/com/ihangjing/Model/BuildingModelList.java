...
public class BuildingModelList {
	...
	public ArrayList<BuildingModel> list;
	private int page;
	private int total;

	public BuildingModelList() {
		this.list = new ArrayList<BuildingModel>();
	}
	...
	public String beanToString() {
		...
		try {
			...
			Iterator<BuildingModel> localIterator = this.list.iterator();
	...
	public BuildingModelList stringToBean(String paramString) {
		if ((paramString == null)
		...
		try {
			...
			while (true) {
				...
				BuildingModel localShopBean1 = new BuildingModel();
