...
public class GroupItemListModel {
	...
	public ArrayList<GroupItemInfo> list;
	private int page;
	private int total;

	public GroupItemListModel() {
		this.list = new ArrayList<GroupItemInfo>();
	}
	...
	public String beanToString() {
		...
		try {
			...
			Iterator<GroupItemInfo> localIterator = this.list.iterator();
	...
	public GroupItemListModel stringToBean(String paramString) {
		if ((paramString == null)
		...
		try {
			...
			while (true) {
				...
				GroupItemInfo localShopBean1 = new GroupItemInfo();
