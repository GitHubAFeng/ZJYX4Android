...
public class LimitedModel {// 买搭增
	...
	public List<LimitedAttrModel> listSpec;// 规格
	...
	public void JsonToBean(JSONObject localJSONObject, int sr) {
		...
		try {
			...
			listSpec = new ArrayList<LimitedAttrModel>();
			LimitedAttrModel mode = new LimitedAttrModel();
			mode.cId = 0;
